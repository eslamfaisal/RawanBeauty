final String appName = 'Rawan Beauty';

final String packageName = 'com.rawan.beauty';
...
final String deepLinkName = 'RawanBeauty';

final String baseUrl = 'https://eslam.rawanbeauty.me/app/v1/api/';
